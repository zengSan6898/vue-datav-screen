<template>
  <div class="total-user">
    ...
    <div class="total">
      <countTo :startVal='startVal' :endVal='todayUser' :duration='10' :autoplay="true"></countTo>
    </div>
    <div class="percent-text">
      <span class="percent-text-1">
        每日增长率:<countTo :startVal='startPercent' :endVal='growthLastDay' :duration='1000' :decimals="2" suffix="%"></countTo>
      </span>
    ...
    <div class="percent">
      <div class="percent-inner-wrapper">
        <div class="percent-inner" :style="{ width: `30%` }"/>
      </div>
    </div>
  </div>
</template>
